...
import com.bogewang.config.RabbitMqExchangeConfig;
...
public class Tut3receiver {
    ...
    @RabbitListener(queues = RabbitMqExchangeConfig.QUEUE5)
    public void receiver5(String in) throws InterruptedException{
        receive(in, 5);
    }

    @RabbitListener(queues = RabbitMqExchangeConfig.QUEUE6)
